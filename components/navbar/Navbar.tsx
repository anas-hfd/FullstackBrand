...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 pt-3 sm:pt-4 px-3 sm:px-6 pointer-events-none">
        <div className="max-w-7xl mx-auto flex items-center justify-center">
          ...
          >
            ...
            {/* 2. Desktop Navigation Links (Non-wrapping, exact order) */}
            ...
            {/* 3. Utility Cluster (Brand Switcher, CTA, Theme Toggle, Mobile Trigger) */}
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              {/* Brand Switcher */}
      ...
      {/* 4. Slide-out Glass Mobile Drawer */}
      <AnimatePresence>
        {mobileOpen && (
          <>
            {/* Backdrop */}
            ...
            >
              <div className="space-y-6">
                ...
                {/* Brand Switcher in Mobile Drawer */}
